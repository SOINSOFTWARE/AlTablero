                                            ...
                                            <div class="box box-solid">
                                                <div class="box-body">
                                                    <form id="frmSearch" name="frmSearch" method="POST"
                                                        action="<c:url value='/admin/profesores/actividades?${_csrf.parameterName}=${_csrf.token}' />">
                                            ...
                                            <div class="box box-solid">
                                                ...
                                                <div class="box-body table-responsive">
                                                    <form id="frmSave" name="frmSave" method="POST"
                                                          action="<c:url value='/admin/profesores/actividades/guardar?${_csrf.parameterName}=${_csrf.token}' />">
